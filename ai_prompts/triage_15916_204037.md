...
## Artifact to Classify (#55 of 956)

ID: 204037
Name: Assignment Override (from INC)
Table: sys_script
...
function onBefore(current, previous) {
    //var override = (current.initiated_from.u_assignment_override+'') === 'true';

    //if (override) {
        current.assignment_group = current.initiated_from.assignment_group;
        current.assigned_to = current.initiated_from.assigned_to;
    //}
