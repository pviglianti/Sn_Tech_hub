...
## Artifact to Classify (#43 of 956)

ID: 204025
Name: Auto-Fill caller and opened by
Table: sys_script
...
(function executeRule(current, previous /*null when async*/) {
	...
	current.caller = current.initiated_from.u_requested_by;
	current.opened_for = current.initiated_from.u_requested_for;
