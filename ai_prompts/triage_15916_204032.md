...
## Artifact to Classify (#50 of 956)

ID: 204032
Name: Copy attachments from INC to WO
Table: sys_script
Target Table: sys_attachment
Class: sys_script
...
(function executeRule(current, previous /*null when async*/) {
	...
	wmOrder.addQuery('initiated_from',current.table_sys_id);
	wmOrder.query();
	while(wmOrder.next()){
		GlideSysAttachment.copy('incident',current.table_sys_id,'wm_order',wmOrder.sys_id);
	}
...
```
Artifact collection: sys_attachment
