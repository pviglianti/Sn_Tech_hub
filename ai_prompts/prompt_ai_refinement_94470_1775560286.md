...
- In-scope customized artifacts: 644
- Assigned to features: 644
- Human standalones accepted: 0
- Unassigned: 0
- Provisional features remaining: 0
- Bucket features: 2
...
## Task
You are running the `Final Naming` pass for AI-owned feature refinement.
