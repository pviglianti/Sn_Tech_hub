...
## Artifact to Classify (#33 of 956)

ID: 204011
Name: Update Incident Work Note
Table: sys_script
Target Table: cmdb_ci_outage
Class: sys_script
...
(function executeRule(current, previous /*null when async*/) {
	...
	gs.error("AP_DEBUG_1_TASK_NUMBER" + current.task_number);
	
	var grIncident = new GlideRecord('incident');
	grIncident.addQuery("sys_id",current.task_number);
	grIncident.query();
	
	if(grIncident.next()){
		gs.error("AP_DEBUG_2_TASK_NUMBER");
		grIncident.work_notes = "Outage " + current.u_number + " has been created for this incident.";
		grIncident.update();
	}
...
```
Artifact collection: cmdb_ci_outage
