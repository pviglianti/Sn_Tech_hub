...
## Artifact to Classify (#64 of 956)

ID: 204077
Name: Validate Field Agent Type
Table: sys_script
Target Table: alm_stockroom
Class: sys_script
Origin: modified_ootb
Scope: global
Script/Code:
```
if (!SNC.AssetMgmtUtil.isPluginRegistered('com.snc.field_service_management')) {
...
```
Artifact collection: alm_stockroom
