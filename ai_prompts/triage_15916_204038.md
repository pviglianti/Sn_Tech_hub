...
## Artifact to Classify (#56 of 956)

ID: 204038
Name: Unassign If WO Owning Team Changes
Table: sys_script
...
(function executeRule(current, previous /*null when async*/) {
	...
	while(wotGr.next()) {
		wotGr.setValue('assignment_group', 'NULL');
		wotGr.setValue('assigned_to', 'NULL');
		//wotGr.setValue('state', 10); 
		wotGr.update();
	}
