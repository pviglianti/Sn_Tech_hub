...
## Artifact to Classify (#60 of 956)

ID: 204042
Name: Copy attachments from INC to WOT
Table: sys_script
...
(function executeRule(current, previous /*null when async*/) {
	...
	wmTask.addQuery('parent',current.table_sys_id);
	wmTask.query();
	while(wmTask.next()){
		GlideSysAttachment.copy('wm_order',current.table_sys_id,'wm_task',wmTask.sys_id);
	}
