...
## Artifact to Classify (#66 of 956)

ID: 204103
Name: Check Defect States
Table: sys_script
Target Table: rm_feature
Class: sys_script
...
function onBefore(current, previous) {
	...
	def.addQuery('related_feature', sys);
	...
	if (def.hasNext()) {
		gs.addInfoMessage('Related Defects must be Finished before pushing this Feature.');
		current.setAbortAction(true);
	}
}
```
Artifact collection: rm_feature
