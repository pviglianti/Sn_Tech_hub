...
- ID 203983: Abort Approval/send toWD if Not T&M
- ID 203984: Push assignment group to WO
- ID 203985: Update WOT Assigned to/Assignment Group
- ID 203986: Generate Work Order on Insert
- ID 203987: Map INC fields to WO
- ID 203988: Generate IWTM Workday Code Lookup Values
- ID 203989: Block Creation of Inv if one exists
- ID 203990: Publish latest quote to scratchpad
- ID 203991: Get Vendor ID Number/Reference
- ID 203992: Synchronize Work Notes
