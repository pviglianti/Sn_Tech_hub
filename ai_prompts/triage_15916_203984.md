...
## Artifact to Classify (#21 of 956)

ID: 203984
Name: Push assignment group to WO
Table: sys_script
...
grWO.addEncodedQuery('initiated_from='+current.sys_id);
grWO.query();
while(grWO.next()){
	grWO.u_parent_assignment_group=current.assignment_group;
	grWO.update();
}
	// Add your code here
