...
- Per-assessment analysis_mode decision (2026-03-05): `analysis_mode` (sequential vs depth_first) stored on Assessment model, not as a global property. Global property seeds the default at assessment creation time. Prevents mid-run configuration changes from breaking in-flight pipelines. See commit `6cb7399`.
