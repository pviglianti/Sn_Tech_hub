...
STAGE_TOOL_SETS: Dict[str, List[str]] = {
    "ai_analysis": [
        ...
        f"{_PREFIX}query_instance_live",
        f"{_PREFIX}search_servicenow_docs",
        f"{_PREFIX}fetch_web_document",
    ...
    "ai_refinement": [
        ...
        f"{_PREFIX}update_feature",
        f"{_PREFIX}create_feature",
        f"{_PREFIX}add_result_to_feature",
        f"{_PREFIX}remove_result_from_feature",
        f"{_PREFIX}get_result_detail",
        f"{_PREFIX}feature_grouping_status",
        f"{_PREFIX}get_customizations",
        f"{_PREFIX}get_suggested_groupings",
    ],
    "grouping": [
        f"{_PREFIX}get_suggested_groupings",
        f"{_PREFIX}get_feature_detail",
    ...
    "recommendations": [
        f"{_PREFIX}upsert_feature_recommendation",
        f"{_PREFIX}get_feature_detail",
        f"{_PREFIX}get_customizations",
        f"{_PREFIX}feature_grouping_status",
    ],
